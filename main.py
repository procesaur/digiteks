...
from helper import zip_bytes_string, do, encode_images, decode_images, make_id, cfg
...
def ini(lang):
    ...
    return render_template('digiteks.html', lang=lang, html_conf=cfg["html_config"], images=encode_images(images), filename=filename)
